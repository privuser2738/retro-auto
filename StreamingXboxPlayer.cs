...
namespace RetroAuto
{
    ...
    public class StreamingXboxPlayer : IDisposable
    {
        ...
        private const string DEFAULT_EMULATOR_PATH = @"C:\Users\rob\Games\Xemu\xemu.exe";
        ...
        public StreamingXboxPlayer(string? archiveUrl = null, string? emulatorPath = null, string? gamesDirectory = null)
        {
